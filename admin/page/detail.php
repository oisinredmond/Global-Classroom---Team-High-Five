      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="http://ttp://juuheeeee950625.xyz/Global-Classroom-Team-High-Five/main.php"><i class="icon-share"></i> Booking Page</a></li>
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main bookinginfo">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
			  ...
			  <?php
			  include './auth.php';
			  $result = mysqli_query($dbConnect,"Select * from bookings where booking_id=".$_GET['booking']."");
				if( mysqli_num_rows($result) >0){
					...
					$q = mysqli_query($dbConnect,"SELECT count(booking_item.room_id) AS total, rooms.room_name AS name
																...
																WHERE booking_item.booking_id =".$rows['Booking_id'].";");
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main editbooking" style="display:block">
			 <button type="button" class="btn" id="back">Back</button><hr>
				 <form  role="form" action="updatebooking.php" method="post">
						...
						include './auth.php';
						$id = $_GET['booking'];
						$r = mysqli_query($dbConnect,"select * from bookings where booking_id=".$id."");
						if(mysqli_num_rows($r)>0){
							while($rows = mysqli_fetch_array($r))
							{
print "							<label for=\"paymentstatus\">Payment Status</label>\n";
print "				<input type=\"hidden\" name=\"bookingid\" id=\"bookingid\" value=\"".$id."\">			<select  type=\"text\" class=\"form-control\" name=\"paymentstatus\" id=\"paymentstatus\" placeholder=\"paid or unpaid\" required><option value=\"\"></option><option value=\"paid\">paid</option><option value=\"unpaid\">unpaid</option></select>\n";
print "\n";
print "							<hr>\n";
print "						<label for=\"userid\">User ID</label>	<input type=\"text\" class=\"form-control\" name=\"userid\" id=\"userid\" placeholder=\"userid\" value=\"".$rows['User_id']."\">\n";

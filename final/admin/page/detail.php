...
print "				<input type=\"hidden\" name=\"bookingid\" id=\"bookingid\" value=\"".$id."\">			<select  type=\"text\" class=\"form-control\" name=\"paymentstatus\" id=\"paymentstatus\" placeholder=\"paid or unpaid\" required><option value=\"\"></option><option value=\"checkout\">checkout</option><option value=\"paid\">paid</option><option value=\"unpaid\">unpaid</option></select>\n";
print "\n";
print "							<hr>\n";

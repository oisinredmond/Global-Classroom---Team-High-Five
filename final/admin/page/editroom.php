...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <li><a href="facility.php"><i class="icon-key"></i> Facilities</a></li>
		...
		include './auth.php';
		$result = mysqli_query($dbConnect,"SELECT * from rooms where room_id ='".$room_id."' ");
   ...
   print "						<input type=\"text\" class=\"form-control\" name=\"size\" id=\"size\" placeholder=\"The size of this room\" value=\"".$rows['Room_Size']."\">\n";
   print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
    ...
    print "						<input type=\"text\" class=\"form-control\" name=\"price\" id=\"price\" value=\"".$rows['Price']."\" required=\"\">\n";
    print "					  </div>\n";
		print "						<img src=\"../".$rows['img']."\" style=\"height:200px; width:200px;\"/>";
		print "					  <div class=\"form-group\">\n";

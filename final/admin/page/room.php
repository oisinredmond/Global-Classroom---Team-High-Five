      ...
      <div class="row">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody id="roominfo"  >
					<?php
						include './auth.php';
						$result = mysqli_query($dbConnect,"select * from rooms");


						if(mysqli_num_rows($result) > 0){
							while ($row = mysqli_fetch_array($result) ){

								print "<tr style=\"\">		 <td>".$row['Room_id']."</td>\n";
                print "<td>".$row['Room_name']."</td>\n";
								print "                  <td><img src=\"../".$row['img']."\" style=\"height:50px;width:50px;\"\"></td>\n";
						print "                  <td>".$row['Room_Size']."</td>\n";
		...
		<button type="button" class="btn" id="back">Back</button>
            ...
            <div class="form-group">
						...
						<input type="text" class="form-control" name="room_id" id="room_id" placeholder="Room ID" required>
					  </div>
					  <div class="form-group">
            ...
            <input type="text" class="form-control" name="room_size" id="room_size" placeholder="Room Size" required>
            </div>
					   <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control"  nsme="rate" id="rate" placeholder="Write without EURO" required>
					  </div>
            <div class="form-group">
          <label for="Price">Price</label>
          <input type="text" class="form-control" name="price" id="price" placeholder="price of this room">
          </div>

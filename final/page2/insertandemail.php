...
include './auth.php';
 ...
 mysqli_query($dbConnect, "INSERT INTO bookings (Booking_id, User_id ,Total_Adults, Total_Children, Check_in, Check_out, Notes, Payment_Status, Total_Cost, Deposit, first_name, last_name, email, telephone_no, add_line1, add_line2, city, state, postcode, country )VALUES (NULL, '".$_SESSION['userID']."','".$_SESSION['adults']."' , '".$_SESSION['childrens']."', '".$_SESSION['checkin_db']."', '".$_SESSION['checkout_db']."', '".$_SESSION['special_requirement']."', 'unpaid', '".$_SESSION['total_amount']."', '".$_SESSION['deposit']."', '".$_SESSION['firstname']."', '".$_SESSION['lastname']."', '".$_SESSION['email']."', '".$_SESSION['phone']."', '".$_SESSION['addressline1']."', '".$_SESSION['addressline2']."', '".$_SESSION['city']."', '".$_SESSION['state']."', '".$_SESSION['postcode']."', '".$_SESSION['country']."');");
echo mysqli_error($dbConnect);
 mysqli_query($dbConnect,"INSERT INTO booking (booking_id, total_adult, total_children, checkin_date, checkout_date, special_requirement, payment_status, total_amount, deposit, first_name, last_name, email, telephone_no, add_line1, add_line2, city, state, postcode, country)VALUES (NULL, '".$_SESSION['adults']."' , '".$_SESSION['childrens']."', '".$_SESSION['checkin_db']."', '".$_SESSION['checkout_db']."', '".$_SESSION['special_requirement']."', 'pending', '".$_SESSION['total_amount']."', '".$_SESSION['deposit']."', '".$_SESSION['firstname']."', '".$_SESSION['lastname']."', '".$_SESSION['email']."', '".$_SESSION['phone']."', '".$_SESSION['addressline1']."', '".$_SESSION['addressline2']."', '".$_SESSION['city']."', '".$_SESSION['state']."', '".$_SESSION['postcode']."', '".$_SESSION['country']."');");
 mysqli_query($dbConnect,"INSERT INTO address (Line_1, Line_2, User_id, city, Ad_State, Post_code, Country,User_id) VALUES ('".$_SESSION['addressline1']."', '".$_SESSION['addressline2']."', '".$_SESSION['city']."', '".$_SESSION['state']."', '".$_SESSION['postcode']."', '".$_SESSION['country']."','".$_SESSION['userID']."');");

$_SESSION['booking_id'] = mysqli_insert_id($dbConnect);
printf ("New Record has id %d.\n", mysqli_insert_id($dbConnect));
echo mysqli_error($dbConnect);
$count = 0;
foreach ($_SESSION['room_id'] as &$value0  ) {

mysqli_query($dbConnect,"INSERT INTO `roombook` (`booking_id`, `room_id`, `totalroombook`, `id`) VALUES ('".$_SESSION['booking_id']."', '".$value0."', '".$_SESSION['roomqty'][$count]."', NULL);");
$count = $count+1;
mysqli_query($dbConnect,"INSERT INTO `booking_item` (`Booking_id`, `Room_id`) VALUES ('".$_SESSION['booking_id']."', '".$value0."');");
$count = $count+1;
} ;

...
if(isset($_POST["checkin"]) && !empty($_POST["checkin"]) && isset($_POST["checkout"]) && !empty($_POST["checkout"])){
	$_SESSION['checkin_date'] = date('y-m-d', strtotime($_POST['checkin']));
	$_SESSION['checkout_date'] = date('y-m-d', strtotime($_POST['checkout']));
...
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#2f2a60;">2</a>
...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<div class="large-12 columns " >
		<p><b>Your Reservation</b></p><hr style="background-color:#2f2a60"class="line">
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<br><button name="submit" href="#" class="button small fontslabo" style="background-color:#2f2a60; width:100%;" >Edit Reservation</button>
					</div>
				  </div>
				</form>
		</div>
		<div class="large-12 columns" id="roomselected" style="display:none;" >
				<hr style="background-color : #2f2a60">
							<br><label for="submit-form" class="book button small fontslabo" style="background-color:#2f2a60; width:100%; height:45px; !important;">Proceed To Book</label><!--button name="submit" href="#" class="button small fontslabo" style="background-color:#2f2a60; width:100%;" >Proceed Booking</button-->
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : EURO </span><span style=\"font-size:24px;\">".$sub_row['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
								...
								print "											<option  value=\"No\">0</option>\n";
																				$i = 1;
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : EURO </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
								...
								//print "				<button type=\"submit\"  class=\"book button small\" style=\"background-color:#2f2a60; width:100%; height:45px; !important;\" >Book</button>\n";
								print "								</div>\n";
								print "							</div>\n";
								print "						</div>\n";
								print "						\n";

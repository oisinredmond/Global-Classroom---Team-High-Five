...
echo $_SESSION['roomname'];
				...
				$result = mysqli_query($dbConnect,"select * from room ");
...
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#00136b;">3</a>
...
<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		...
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo" style="background-color:#00136b;" onclick="return confirm('Are you sure you want to continue?')" >Confirm</button>
		  </div>
...
<script>
	function validateForm(form) {
		...
		var country = form.country.value;
			if(fname == null || lname == null || email == null || phone == null || add1 == null || postcode == null|| city == null|| state == null || country == null ||



				 == "" || lname == "" || email == "" || phone == "" || add1 == "" || postcode == "" || city == "" || state == "" || country == "")
			{
